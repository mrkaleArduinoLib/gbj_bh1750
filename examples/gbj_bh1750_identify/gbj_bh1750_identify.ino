/*
  ...
  Author: Libor Gabaj
*/
#define SKETCH "GBJ_BH1750_IDENTIFY 1.1.0"
...
void setup()
{
  ...
  Serial.println("Accuracy (min/typ/max): " + String(Sensor.getAccuracyMin()) + "/" + String(Sensor.getAccuracyTyp()) + "/" + String(Sensor.getAccuracyMax()) + " bitCount/lux");
  Serial.println("---");
  // Low mode
  Serial.println("Mode: " + getModeName());
  Serial.println("SenseCoef: " + String(Sensor.getSenseCoef()));
  Serial.println("Sensitivity (min/typ/max): " + String(Sensor.getSensitivityMin()) + "/" + String(Sensor.getSensitivityTyp()) + "/" + String(Sensor.getSensitivityMax()) + " lux/bitCount");
  Serial.println("Resolution (min/typ/max): " + String(Sensor.getResolutionMin()) + "/" + String(Sensor.getResolutionTyp()) + "/" + String(Sensor.getResolutionMax()) + " bitCount/lux");
  Serial.println("Measurement time (min/typ/max): " + String(Sensor.getMeasurementTime()) + "/" + String(Sensor.getMeasurementTimeTyp()) + "/" + String(Sensor.getMeasurementTimeMax()) + " ms");
  Serial.println("---");
